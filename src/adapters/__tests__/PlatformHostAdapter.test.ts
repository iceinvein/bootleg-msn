...
import { PlatformHostAdapter, createPlatformHostAdapter } from "../PlatformHostAdapter";
...
describe("PlatformHostAdapter", () => {
	...
	describe("Overlay System Connection", () => {
		it("should connect to overlay system", () => {
			...
			expect(() => adapter.connectOverlaySystem(mockOverlayCallbacks)).not.toThrow();
		});
	...
	describe("Deep Link Handling", () => {
		...
		it("should handle deep link with URL overlay handler", () => {
			...
			expect(mockOverlayCallbacks.handleUrlOverlay).toHaveBeenCalledWith(testUrl);
		});
