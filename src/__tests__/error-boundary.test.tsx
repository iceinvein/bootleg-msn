...
describe("Error Boundary Tests", () => {
  ...
  describe("Error Types and Scenarios", () => {
    ...
    it("should handle multiple error boundaries", () => {
      render(
        <TestErrorBoundary fallback={<div data-testid="outer-error">Outer error</div>}>
          <div>
            <TestErrorBoundary fallback={<div data-testid="inner-error">Inner error</div>}>
              <ThrowingComponent shouldThrow={true} />
            </TestErrorBoundary>
          </div>
        </TestErrorBoundary>
  ...
  describe("Error Boundary Limitations", () => {
    it("should not catch errors in event handlers", () => {
      const EventErrorComponent = () => {
        ...
        return <button onClick={handleClick} data-testid="event-button">Click me</button>;
      };
  ...
  describe("Error Recovery", () => {
    it("should allow error boundary to reset", () => {
      const ResettableErrorBoundary = ({ children, reset }: { 
        ...
        if (hasError) {
          return (
            <div data-testid="error-with-reset">
              Error occurred
              <button onClick={() => setHasError(false)} data-testid="reset-button">
                Reset
              </button>
            </div>
          );
