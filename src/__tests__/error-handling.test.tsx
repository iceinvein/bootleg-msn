...
describe("Error Handling & Edge Cases", () => {
	...
	describe("Authentication Error Handling", () => {
		it("should handle null/undefined errors gracefully", () => {
			...
			expect(nullResult.message).toBe(
		...
		it("should identify specific error types correctly", () => {
			expect(
				isAuthErrorType(new Error("Invalid password"), "authentication"),
			).toBe(true);
			expect(
				isAuthErrorType(new Error("Too many requests"), "rate_limit"),
			).toBe(true);
			expect(isAuthErrorType(new Error("Network error"), "network")).toBe(true);
			expect(isAuthErrorType(new Error("Random error"), "authentication")).toBe(
				false,
			);
		});
	...
	describe("File Upload Error Scenarios", () => {
		...
		it("should handle invalid file types", () => {
			const invalidFiles = [
				...
				new File(["content"], "malware.scr", {
					type: "application/x-screensaver",
				}),
			];
