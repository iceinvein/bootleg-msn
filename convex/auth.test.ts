...
describe('Authentication System', () => {
  describe('loggedInUser query', () => {
    ...
    it('should return user when authenticated', async () => {
      ...
      const result = await t.withIdentity({ subject: userId }).query(api.auth.loggedInUser, {});
  ...
  describe('updateUserName mutation', () => {
    it('should update user name when authenticated', async () => {
      ...
      await t.withIdentity({ subject: userId }).mutation(api.auth.updateUserName, { 
        name: "John Doe" 
      });
  ...
  describe('updateUserImage mutation', () => {
    it('should update user image when authenticated', async () => {
      ...
      await t.withIdentity({ subject: userId }).mutation(api.auth.updateUserImage, { 
        image: imageUrl 
      });
    ...
    it('should throw error when not authenticated', async () => {
      ...
      // Try to update without authentication
      await expect(
        t.mutation(api.auth.updateUserImage, { image: "https://example.com/avatar.jpg" })
      ).rejects.toThrow();
    });
  });
  ...
  describe('checkEmailVerificationForAuth mutation', () => {
    it('should return true when email is verified', async () => {
      ...
      const result = await t.mutation(api.auth.checkEmailVerificationForAuth, { email });
  ...
  describe('getUserAuthMethods query', () => {
    it('should return auth methods object when user has no auth methods', async () => {
      ...
      // Get auth methods
      const result = await t.withIdentity({ subject: userId }).query(api.auth.getUserAuthMethods, {});
